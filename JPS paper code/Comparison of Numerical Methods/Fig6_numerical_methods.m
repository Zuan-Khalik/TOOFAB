...
% "Fig8_obtain_data.m" 
load results_LS.mat % Data from simulation using method of [3]
load results_LX.mat % Data from simulation using method of [2]
load results_ZK.mat % Data from simulation using method of [1]
figure(1)
