...
out = LS_simulation();
sim_time_total = out.sim_time_total;
sim_time = out.simulation_time;

save('Data/results_LS_orig','out')
function out = LS_simulation()
...
% save('D:\OneDrive - TU Eindhoven\PhD\Research\Battery simulation toolboxes\LIONSIMBA-master\battery_model_files\external_functions/F_i_app','F_current')
% 
...
param{1}.sim_datalog_interval = 1;
...
tf = 4000;
out = startSimulation(1,tf,initialState,0,param);
